...
namespace bookprob
{
    class dkl_book : public book
    {
        ...
        mutable std::vector<std::pair<dt::hash_type, double>> frequency /** The order of the words in the book with their frequency.*/;
    ...
    public:
        ...
        dkl_book(const std::vector<dt::hash_type> &list, const glob_prob *inP0 = NULL, double Alpha = -100, double Theta = -100, std::string pref = "") : book(list, inP0, Alpha, Theta, pref) { cache_valid = false; };
