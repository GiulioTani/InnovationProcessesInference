...
namespace bookprob
{
    ...
    public:
        ...
        dkl_book(const std::vector<std::pair<hash_type, int>> &ord, const std::vector<int> &times, const glob_prob *inP0 = NULL, double Alpha = -100, double Theta = -100, std::string pref = "") : book(ord, times, inP0, Alpha, Theta, pref) { cache_valid = false; };
